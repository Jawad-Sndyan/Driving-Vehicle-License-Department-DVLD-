...
namespace DVLD_DataAccess
{
    public class clsDetainedLicenseData
    {
        ...
        public static DataTable GetAllDetainedLicenses()
        {
            ...
            string query = @"SELECT DL.DetainID,DL.LicenseID,DL.DetainDate,DL.IsReleased,DL.FineFees,DL.ReleaseDate,
                            P.NationalNo,FullName=P.FirstName+' '+P.SecondName+ISNULL(' '+P.ThirdName,'')+' '+P.LastName,
                            ...
                            order by DL.IsReleased ,DL.DetainID";
